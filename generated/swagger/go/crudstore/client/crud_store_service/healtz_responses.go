...
import (
	...
	"github.com/makkalot/eskit/generated/swagger/go/crudstore/models"
)
...
type HealtzOK struct {
	Payload *models.CrudstoreHealthResponse
}
...
func (o *HealtzOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CrudstoreHealthResponse)
